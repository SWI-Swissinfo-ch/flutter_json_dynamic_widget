      ...
      if (map is TeamBuilderModel) {
        ...
        result = TeamBuilderModel(
          ...
          nullableDefaultPerson:
              map['nullableDefaultPerson'] == null
                  ? null
                  : Person.fromJson(map['nullableDefaultPerson']),
          nullablePerson:
              map['nullablePerson'] == null
                  ? null
                  : Person.fromJson(map['nullablePerson']),
          nullablePersonType:
              map['nullablePersonType'] == null
                  ? null
                  : PersonType.fromJson(map['nullablePersonType']),
          person: Person.fromJson(map['person']),
          personList:
              map['personList'].map<Person>((e) => Person.fromJson(e)).toList(),
          personSet:
              map['personSet'].map<Person>((e) => Person.fromJson(e)).toSet(),
