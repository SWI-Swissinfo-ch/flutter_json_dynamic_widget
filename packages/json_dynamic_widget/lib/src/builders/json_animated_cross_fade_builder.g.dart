    ...
    if (map != null) {
      ...
      if (map is JsonAnimatedCrossFadeBuilderModel) {
        ...
        result = JsonAnimatedCrossFadeBuilderModel(
          ...
          crossFadeState: () {
            dynamic parsed = ThemeDecoder.instance.decodeCrossFadeState(
              map['crossFadeState'],
              validate: false,
            );
  ...
  Map<String, dynamic> toJson() {
    return JsonClass.removeNull({
      'alignment': Alignment.topCenter == alignment
          ? null
          : ThemeEncoder.instance.encodeAlignmentGeometry(alignment),
      'crossFadeState': ThemeEncoder.instance.encodeCrossFadeState(
        crossFadeState,
      ),
      'duration': duration.inMilliseconds,
      'excludeBottomFocus': true == excludeBottomFocus
          ? null
          : excludeBottomFocus,
      'firstChild': firstChild.toJson(),
      'firstCurve': Curves.linear == firstCurve
          ? null
          : CurvesValues.encode(firstCurve),
      ...
      'sizeCurve': Curves.linear == sizeCurve
          ? null
          : CurvesValues.encode(sizeCurve),
