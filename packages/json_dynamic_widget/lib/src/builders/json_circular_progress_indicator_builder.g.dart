...
class JsonCircularProgressIndicator extends JsonWidgetData {
  ...
  /* AUTOGENERATED FROM [CircularProgressIndicator.controller]*/
    ...
    if (map != null) {
      ...
      if (map is JsonCircularProgressIndicatorBuilderModel) {
        ...
        result = JsonCircularProgressIndicatorBuilderModel(
          ...
          strokeCap: () {
            dynamic parsed = ThemeDecoder.instance.decodeStrokeCap(
              map['strokeCap'],
              validate: false,
            );
  ...
  Map<String, dynamic> toJson() {
    return JsonClass.removeNull({
      ...
      'strokeAlign': CircularProgressIndicator.strokeAlignCenter == strokeAlign
          ? null
          : strokeAlign,
      'strokeCap': ThemeEncoder.instance.encodeStrokeCap(strokeCap),
      'strokeWidth': strokeWidth,
      'trackGap': trackGap,
      'value': value,
