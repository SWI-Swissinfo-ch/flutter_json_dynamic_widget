...
class JsonIconBuilderModel extends JsonWidgetBuilderModel {
    ...
    if (map != null) {
      ...
      if (map is JsonIconBuilderModel) {
        ...
        result = JsonIconBuilderModel(
          ...
          fontWeight: () {
            dynamic parsed = ThemeDecoder.instance.decodeFontWeight(
              map['fontWeight'],
              validate: false,
            );
  ...
  Map<String, dynamic> toJson() {
    return JsonClass.removeNull({
      'applyTextScaling': applyTextScaling,
      'blendMode': ThemeEncoder.instance.encodeBlendMode(blendMode),
      'color': ThemeEncoder.instance.encodeColor(color),
      'fill': fill,
      'fontWeight': ThemeEncoder.instance.encodeFontWeight(fontWeight),
      'grade': grade,
      'icon': ThemeEncoder.instance.encodeIconData(icon),
      'opticalSize': opticalSize,
      'semanticLabel': semanticLabel,
      'shadows': shadows,
      'size': size,
