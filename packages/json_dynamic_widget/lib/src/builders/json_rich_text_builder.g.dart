...
class JsonRichTextBuilderModel extends JsonWidgetBuilderModel {
    ...
    if (map != null) {
      ...
      if (map is JsonRichTextBuilderModel) {
        ...
        result = JsonRichTextBuilderModel(
          ...
          overflow: () {
            dynamic parsed = ThemeDecoder.instance.decodeTextOverflow(
              map['overflow'],
              validate: false,
            );
          ...
          textHeightBehavior: () {
            dynamic parsed = ThemeDecoder.instance.decodeTextHeightBehavior(
          ...
          textWidthBasis: () {
            dynamic parsed = ThemeDecoder.instance.decodeTextWidthBasis(
              map['textWidthBasis'],
              validate: false,
            );
  ...
  Map<String, dynamic> toJson() {
    return JsonClass.removeNull({
      'locale': ThemeEncoder.instance.encodeLocale(locale),
      'maxLines': maxLines,
      'overflow': TextOverflow.clip == overflow
          ? null
          : ThemeEncoder.instance.encodeTextOverflow(overflow),
      ...
      'text': ThemeEncoder.instance.encodeInlineSpan(text),
      ...
      'textScaler': TextScaler.noScaling == textScaler
          ? null
          : ThemeEncoder.instance.encodeTextScaler(textScaler),
      'textWidthBasis': TextWidthBasis.parent == textWidthBasis
          ? null
          : ThemeEncoder.instance.encodeTextWidthBasis(textWidthBasis),
...
class RichTextSchema {
  ...
  static final schema = <String, Object>{
    ...
    'properties': {
      ...
      'text': SchemaHelper.objectSchema(InlineSpanSchema.id),
