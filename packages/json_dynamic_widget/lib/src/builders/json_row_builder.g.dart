    ...
    if (map != null) {
      ...
      if (map is JsonRowBuilderModel) {
        ...
        result = JsonRowBuilderModel(
          ...
          textBaseline: () {
            dynamic parsed = ThemeDecoder.instance.decodeTextBaseline(
              map['textBaseline'],
              validate: false,
            );
  ...
  Map<String, dynamic> toJson() {
    return JsonClass.removeNull({
      'crossAxisAlignment': CrossAxisAlignment.center == crossAxisAlignment
          ? null
          : ThemeEncoder.instance.encodeCrossAxisAlignment(crossAxisAlignment),
      'mainAxisAlignment': MainAxisAlignment.start == mainAxisAlignment
          ? null
          : ThemeEncoder.instance.encodeMainAxisAlignment(mainAxisAlignment),
      'mainAxisSize': MainAxisSize.max == mainAxisSize
          ? null
          : ThemeEncoder.instance.encodeMainAxisSize(mainAxisSize),
      'spacing': 0.0 == spacing ? null : spacing,
      'textBaseline': ThemeEncoder.instance.encodeTextBaseline(textBaseline),
      ...
      'verticalDirection': VerticalDirection.down == verticalDirection
          ? null
          : ThemeEncoder.instance.encodeVerticalDirection(verticalDirection),
